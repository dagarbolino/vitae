    ...
    <Section className="w-auto box-border m-0 p-0 gap-6 flex flex-col justify-between items-center min-h-screen bg-gradient-to-r from-blue-500 to-green-500">
      ...
      <div className="flex flex-row justify-center items-center gap-10">
        <div className="flex flex-col justify-center items-center gap-10">
          ...
          <h2 className='text-2xl my-4'>Liste des Langues</h2>
            ...
            <ul>
              {languages.map(language => (
                <li
                  ...
                  key={language.id}>
                  {language.title_language} - {language.niveau_language} - {language.active ? 'Actif' : 'Inactif'}
                  <button
        ...
        <div className="flex flex-col justify-center items-center gap-10">
          {/* Modifier une langue */}
          <h2 className='text-2xl my-4'>Modifier une langue</h2>
          <div className='border-2 rounded-md p-4 w-96'>
