...
const ListEditDeleteInfo = () => {
  ...
  const navigateToCreateInfo = () => {
    navigate('/info/create'); // Étape 3: Utiliser navigate pour la navigation
  };
    ...
    <Section className="w-auto box-border m-0 p-0 gap-6 flex flex-col justify-between items-center min-h-screen bg-gradient-to-r from-blue-500 to-green-500">
      ...
      <div className="flex flex-row justify-center items-center gap-10">
        <div className="flex flex-col justify-center items-center gap-10">
          ...
          <button
            className='bg-blue-500 text-xl text-white px-2 py-1 rounded-md hover:bg-blue-700 transition-colors mb-4'
            onClick={navigateToCreateInfo}>Créer Info</button>
