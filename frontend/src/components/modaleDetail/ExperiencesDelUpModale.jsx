  ...
  return (
      ...
      <div className="flex flex-col justify-center items-center gap-10">
        <div className="flex flex-col justify-center items-center gap-10">
          ...
          <div className='border-2 rounded-md mt-2 p-4 w-96'>
            ...
            <ul>
              {experiences.map(experience => (
                <li
                  ...
                  key={experience.id}>
                  {experience.title_experience} - {experience.location_experience}
                  <button
                  ...
                  {editingId === experience.id ? (
                    <>
                      ...
                      <div className="">
                        ...
                        <div className="mt-4">
                          <button
                            className='bg-green-500 text-white px-2 py-1 rounded-md mt-2 hover:bg-green-700 transition-colors'
                    ...
                    <>
                      {experience.title_experience} - {experience.location_experience} 
                      <button
                        className='bg-blue-500 text-white px-2 py-1 rounded-md mt-2 hover:bg-blue-700 transition-colors'
...
export default ExperiencesDelUpModale;