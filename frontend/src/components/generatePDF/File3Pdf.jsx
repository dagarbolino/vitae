                    ...
                    <div className="flex flex-col justify-center items-center">
                      ...
                      <div className="flex flex-row-reverse justify-center items-center">
                        ...
                        <div className="">
                          {cvData.infos && cvData.infos.map((info, infoIndex) => (
                            <div key={infoIndex} className='flex flex-col w-full gap-3'>
                              <p className='text-4xl font-semibold'>{info.lastname}</p>
                              <p className='text-4xl font-semibold'>{info.firstname}</p>
                      ...
                      <div className="flex flex-row justify-start items-start gap-4 h-full">
                        ...
                        <div className="border-4 border-gray-200 rounded-md p-5 bg-white  h-full">
                          <h3 className='text-2xl font-semibold  w-full flex flex-row justify-center items-center'>Formations</h3>
                        ...
                        <div className="border-4 border-gray-200 rounded-md  p-5 bg-white  h-full">
                          <h3 className='text-2xl font-semibold  w-full flex flex-row justify-center items-center'>Expériences</h3>
                      ...
                      <div className="flex flex-row justify-between items-start p-6 w-full">
                        <div className="">
                          {cvData.infos && cvData.infos.map((info, infoIndex) => (
                            <div key={infoIndex} className='flex flex-col w-full gap-3'>
                        ...
                        <div className="flex flex-col justify-start items-start">
                          <h3 className='text-xl font-bold  w-full  mb-2'>Hobbies</h3>
                          {cvData.hobbies && cvData.hobbies.map((hobby, hobbyIndex) => (
                            <li key={hobbyIndex} className='list-inside  text-md '>
                              {hobby.title_hobby}
                            </li>
                          ))}
                        </div>
                        <div className="flex flex-col justify-start items-start">
                          <h3 className='text-xl font-bold  w-full mb-2'>Compétences</h3>
                          {cvData.skills && cvData.skills.map((skill, skillIndex) => (
                            <li key={skillIndex} className='list-inside  text-md '>
                              {skill.title_skill}
                            </li>
                          ))}
                        </div>
                        <div className="flex flex-col justify-start items-start">
                          <h3 className='text-xl font-bold  w-full mb-2'>Langues</h3>
                          {cvData.languages && cvData.languages.map((language, languageIndex) => (
                            <li key={languageIndex} className='text-md '>
                              <div className="">
                                <li key={languageIndex} className='list-inside  text-md'>
